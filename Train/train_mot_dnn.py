...
from reid.loss.loss_set import CrossEntropyLabelSmoothLoss,TripletHardLoss
from torch.optim.lr_scheduler import CosineAnnealingLR
from torch.utils.data import Subset
from datasets.ValBuilder import ValBuilder
from Train.engine.reid_trainers_dnn import ReidTrainer 
...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default='/home/st3/UnifyTrack/appearance/vis2/u2')
...
def main(args):
    ...
    criterion = [criterion_cls, criterion_tri,criterion_domain]
    ## Optimizer
    # backbone_params = []
    # reid_head_params = []
    # domain_params = []
    ...
    for epoch in range(start_epoch, total_epochs):
        ...
        if (epoch + 1) % 10 == 0 and (epoch + 1) >= args.start_save:
            ...
            }, epoch + 1, is_best, save_interval=1, fpath=osp.join(args.logs_dir, 'u2.pth.tar'))
