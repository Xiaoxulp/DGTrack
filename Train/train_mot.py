...
from Train.engine.reid_trainers import ReidTrainer
...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default='/home/st3/UnifyTrack/appearance/vis2/u1')
...
def main(args):
    ...
    for epoch in range(start_epoch, total_epochs):
        ...
        if (epoch + 1) % 10 == 0 and (epoch + 1) >= args.start_save:
            ...
            }, epoch + 1, is_best, save_interval=1, fpath=osp.join(args.logs_dir, 'u1.pth.tar')) 
