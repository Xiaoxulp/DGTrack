...
def make_parser():
    ...
    parser.add_argument("--data_path", type=str, default="/home/st3/DGTrack/data/MOT20/train/")
    parser.add_argument("--pickle_path", type=str, default="/home/st3/DGTrack/data/MOT20/detections_yolox_x/train/mot20_val_0.80.pickle")
    parser.add_argument("--output_path", type=str, default="/home/st3/DGTrack/data/MOT20/embeddings_yolox_x/train/mot20_val_0.80.pickle")
    parser.add_argument("--weight_path", type=str,default="/home/st3/DGTrack/reid/log/u4_120.pth.tar")
    # Else
