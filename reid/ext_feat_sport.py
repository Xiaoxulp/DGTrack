...
def make_parser():
    ...
    # Data args
    parser.add_argument("--dataset", type=str, default="sprotmot")
    parser.add_argument("--data_path", type=str, default="/home/st3/DGTrack/data/Domain3/images/test/")
    parser.add_argument("--pickle_path", type=str, default="/home/st3/DGTrack/data/Domain3/images/detections_yolox_x/test/sport_test_0.95.pickle")
    parser.add_argument("--output_path", type=str, default="/home/st3/DGTrack/data/Domain3/images/embeddings_yolox_x/test/sport_test_0.95.pickle")
