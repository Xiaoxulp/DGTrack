...
def make_parser():
    ...
    parser.add_argument("--data_path", type=str, default="/home/st3/DGTrack/data/Domain1/images/test/")
    parser.add_argument("--pickle_path", type=str, default="/home/st3/DGTrack/data/Domain1/images/detections_yolox_x/test/dance_test_0.80.pickle")
    parser.add_argument("--output_path", type=str, default="/home/st3/DGTrack/data/Domain1/images/embeddings_yolox_x/test/dance_test_0.80.pickle")
