...
def make_parser():
    ...
    # Can be changed
    parser.add_argument("-f", "--exp_file", default="/home/st3/DGTrack/external/YOLOX/exps/yolox_x_dance_test.py",
                        type=str, help="pls input your experiment description file",)
    parser.add_argument("-c", "--ckpt", default="/home/st3/DGTrack/external/YOLOX/weights/dance.pth.tar",
                        type=str, help="ckpt for eval")
    parser.add_argument("-n", "--exp_name", type=str,
                        default="/home/st3/DGTrack/data/Domain1/images/detections_yolox_x/test/dance_test_0.95.pickle")
