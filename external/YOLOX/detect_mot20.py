...
def make_parser():
    ...
    # Can be changed
    parser.add_argument("-f", "--exp_file", default="/home/st3/DGTrack/external/YOLOX/exps/yolox_x_mot20_test.py",
                        type=str, help="pls input your experiment description file",)
    parser.add_argument("-c", "--ckpt", default="/home/st3/DGTrack/external/YOLOX/weights/mot20.pth.tar",
                        type=str, help="ckpt for eval")
    parser.add_argument("-n", "--exp_name", type=str,
                        default="/home/st3/DGTrack/data/MOT20/detections_yolox_x/test/mot20_test_0.80.pickle")
