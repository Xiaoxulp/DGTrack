...
def make_parser():
    ...
    # Can be changed
    parser.add_argument("-f", "--exp_file", default="/home/st3/DGTrack/external/YOLOX/exps/yolox_x_sportsmot_test.py",
                        type=str, help="pls input your experiment description file",)
    parser.add_argument("-c", "--ckpt", default="/home/st3/DGTrack/external/YOLOX/weights/SportsMOT_yolox_x_mix.tar",
                        type=str, help="ckpt for eval")
    parser.add_argument("-n", "--exp_name", type=str,
                        default="/home/st3/DGTrack/data/Domain3/images/detections_yolox_x/test/sport_test_0.95.pickle")
    ...
    parser.add_argument("--min_box_area", default=100, type=int, help="filter out tiny boxes") # 最小面积配置为100
