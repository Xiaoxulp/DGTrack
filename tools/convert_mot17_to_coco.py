...
# DATA_PATH = 'E:/Paper/CrossMOT/CrossTracker/CrossMOT/data/MOT17'
DATA_PATH = 'D:/Domain_mot/DGTrack/data/Domain2/images'
...
if __name__ == '__main__':
    ...
    for split in SPLITS:
        ...
        for seq in sorted(seqs):
            ...
            num_images = len([image for image in images if 'jpg' in image])  # half
