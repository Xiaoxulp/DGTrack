...
def txt2img(visual_path="visual_val_gt"):
    ...
    gt_json_path = '/home/st3/DGTrack/data/Domain2/images/annotations/test.json'
    img_path = '/home/st3/DGTrack/data/Domain2/images/test/'
    show_video_names = ['MOT17-07-FRCNN']

    test_json_path = '/home/st3/DGTrack/data/Domain2/images/annotations/test.json'
    test_img_path = '/home/st3/DGTrack/data/Domain2/images/test/'
    test_show_video_names = ['MOT17-07-FRCNN']
    ...
    for show_video_name in show_video_names:
        ...
        if visual_path == "visual_val_gt":
            ...
            txt_path = '/home/st3/DGTrack/tools/result/test/mot17/' + show_video_name + '.txt'
        else:
